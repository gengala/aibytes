...
def mla_norope_train(X, W_dkv, W_dq, W_uk, W_uv, W_uq, W_o):
...
def mla_norope_test(X, W_dkv, W_dq, W_uk, W_uv, W_uq, W_o):
...
def __main__():
    ...
    A_train, O_train = mla_norope_train(X, W_dkv, W_dq, W_uk, W_uv, W_uq, W_o)
    A_test, O_test = mla_norope_test(X, W_dkv, W_dq, W_uk, W_uv, W_uq, W_o)
